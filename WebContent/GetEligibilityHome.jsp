...
<br>
   ...
   <div class=example>
    <div class=tabs>
     ...
     <div id=default2 >
     	<a href="GetHome.jsp" target="iframe_a">1.Get Eligibility</a>
     </div>
     
     <div id=default2 onclick="Get Quote">
   ...
   <iframe width="100%" height="600px" src="GetHome.jsp" name="iframe_a"></iframe>
