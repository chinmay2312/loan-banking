...
<nav id="navigation">
		<ul>
			<li><a href="Manager.jsp">Home</a></li>
			 <li><a href="#">View &#9662;</a>
            	<ul class="dropdown">
               		 <li><a href="UpdateInterestRatem.jsp">Interest Rate</a></li>
                	<li><a href="PersonDetm.jsp">Person Details</a></li>
                	<li><a href="loandetailsm.jsp">Loan Details</a></li>
            	</ul>
     		 </li>
     		 <li><a href="r.jsp">Pending Request</a></li>
